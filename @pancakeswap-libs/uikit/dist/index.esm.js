...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 46" }, props),
        React.createElement("image", { width: "102", height: "46", href: isDark ? "images/egg/LogoTextNewDark.png" : "images/egg/LogoTextNewWhite.png" })));
};
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank",className:'price' },
        ...
        React.createElement(SettingsEntry, null,
            React.createElement(Dropdown, { position: "bottom", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.glenty.com/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
